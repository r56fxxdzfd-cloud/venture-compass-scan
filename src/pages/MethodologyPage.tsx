  ...
  return (
    <TooltipProvider>
      <div id="methodology-content" className="space-y-8 max-w-5xl mx-auto">
        ...
        <Card id="section-dimensions" className="executive-panel print-safe">
        ...
        <Card id="section-weights" className="executive-panel print-safe">
        ...
        {config.red_flags && config.red_flags.length > 0 && (
          <Card id="section-redflags" className="executive-panel print-safe">
        ...
        {glossaryEntries.length > 0 && (
          <Card id="section-glossary" className="executive-panel print-safe">
